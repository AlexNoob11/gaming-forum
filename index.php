...
<head>
    ...
    <title>Nexus | Ultimate Gaming Forum</title>
...
<body class="min-h-screen">
    ...
    <div id="toast" class="fixed top-20 right-5 z-[100] glass border border-green-500/50 p-4 rounded-xl flex items-center gap-3 animate-slide-in">
        ...
        <div>
            ...
            <p class="text-xs text-slate-400">Your thread has been launched successfully.</p>
        </div>
        <button onclick="this.parentElement.remove()" class="text-slate-500 hover:text-white ml-2">
